...
namespace Ale_Ink.API.Migrations
{
    ...
    [Migration("20250328014334_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Ale_Ink.Models.Item", b =>
                {
            ...
            modelBuilder.Entity("Ale_Ink.Models.Note", b =>
                {
                    b.Property<int>("NoteId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Ale_Ink.Models.Person", b =>
                {
            ...
            modelBuilder.Entity("Ale_Ink.Models.Place", b =>
                {
            ...
            modelBuilder.Entity("ItemNote", b =>
                {
                    b.HasOne("Ale_Ink.Models.Item", null)
                        .WithMany()
                        .HasForeignKey("ItemsItemId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Ale_Ink.Models.Note", null)
                        .WithMany()
            ...
            modelBuilder.Entity("ItemPerson", b =>
                {
                    ...
                    b.HasOne("Ale_Ink.Models.Person", null)
                        .WithMany()
            ...
            modelBuilder.Entity("ItemPlace", b =>
                {
                    ...
                    b.HasOne("Ale_Ink.Models.Place", null)
                        .WithMany()
